...
<div class="produtos_pai">
			<div class="produtos_filho">
					...
					%>
						<a href="verprodutos?codigo=<%=produto.getCodigo().toString()%>" id="link"><div class="linkards"><img src="<%=produto.getUrl_img()%>" style="width:200px;height:200px;"><p class="nomeProduto"><%=produto.getNome()%></p><p class="precoProduto">R$ <%=produto.getValor_venda()%><p>Em até 10x sem juros!</div></a>
