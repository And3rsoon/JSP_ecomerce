...
<div class="form_login">
 <div class="form_login_filho">
 	<div class="form_login_filho1">
 	<p class="nome_login">Login</p>
 	<form action="login" method="post">
			<tag for="">CPF: </tag><input class="input_cpf" name="cpf" type="text" required><br>
			<tag for="">Senha: </tag><input class="input_senha" name="senha" type="password" required><br>
			<button type="submit" class="botao_form">Entrar</button>
	</form>
	</div>
</div>
<div class="cadastro"><a href="cadastro">Novo por aqui? cadastre-se agora!</a> </div>
